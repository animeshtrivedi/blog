...
Unfortunately this blog was done using multiple commits from November, 2018. Just browse the code, otherwise write to me. 
 ...
 3. [Comparing with Java Code](#comparing-with-java-code)     
     ...
     - 3.3 [C++ Optimizations](#c-optimizations)          
...
## Thanks
Thanks [@pepperjo](https://github.com/PepperJo) for helping me to debug the performance issues. I used [JITWatch](https://github.com/AdoptOpenJDK/jitwatch) to look though the JIT assembly, and got help from [@chriswhocodes](https://github.com/chriswhocodes).
